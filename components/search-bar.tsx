  ...
  return (
    <div className={`relative ${className}`}>
      ...
      <input
        ...
        className="w-full bg-neutral-900 border border-neutral-700 rounded-lg pl-9 pr-9 py-2 text-sm text-neutral-100 placeholder:text-neutral-500 focus:outline-none focus:border-neutral-500 focus:ring-1 focus:ring-neutral-500 transition-colors"
      />
      {value && (
        <button
          onClick={handleClear}
