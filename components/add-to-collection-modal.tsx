            ...
            <>
              ...
              {collections.map((col) => (
                <button
                  ...
                  className="w-full flex items-center justify-between px-3 py-2.5 rounded-lg bg-muted hover:bg-accent border border-border hover:border-border/60 transition-colors disabled:opacity-50 disabled:cursor-not-allowed text-left"
                >
                  ...
                  <div className="flex items-center gap-2 ml-2 shrink-0">
                    <span className="text-xs text-muted-foreground">{col.game_count} games</span>
                    {submitting === col.id && (
              ...
              {!showNewForm ? (
                <button
                  ...
                  className="w-full flex items-center gap-2.5 px-3 py-2.5 rounded-lg border border-dashed border-border hover:border-border/60 text-muted-foreground hover:text-foreground transition-colors text-sm"
                >
